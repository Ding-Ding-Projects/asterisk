...
test('total bound-screen and control counts are what this pass produced', () => {
  ...
  // And 199 with the Database backends screen, a whole new 17th screen and file: eight
  // res_pgsql.conf [general] keys bound plainly (this screen's own declared `file`, no
  // override needed) and twelve res_odbc.conf keys bound through
