...
/* 334 total / 333 working, up from 286/286, once the ops lane's five screens landed:
 * Monitoring (res_snmp.conf + prometheus.conf, 11 controls, all working -- the write-only
...
const WORKING_FLOOR = 333;
const TELEPHONY_TOTAL = 334;
