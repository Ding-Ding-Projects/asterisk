...
The five switches are mounted from the durable settings snapshot when the desktop application starts, and every control writes through the same `DurableStorage` handle.
