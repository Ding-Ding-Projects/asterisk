...
if (!provenance || provenance.algorithm !== 'SHA-256' || !Array.isArray(provenance.sources) || provenance.sources.length < 2 || provenance.sources.some((source) => source.value !== gh[0].archiveSha256)) {
