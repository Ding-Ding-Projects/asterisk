...
const siteStatus = {
  ...
  'per-element-toy-locks': 'absent', 'support-tickets': 'absent', 'unlock-ladder': 'absent',
  ...
  'bounded-overlays': 'implemented-unverified', 'context-menu-shortcuts': 'implemented-unverified',
