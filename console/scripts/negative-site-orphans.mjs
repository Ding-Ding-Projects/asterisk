...
//    Publishing history.html without removing its entry must be caught, or the list
//    silently stops describing the tree.
planted('a stale record for a file that is now published', () =>
  rewrite(sitePath('build.mjs'), (text) =>
    text.replace("const assets = ['index.html'", "const assets = ['history.html', 'index.html'")));
