...
if (identity.schemaVersion !== 1 || identity.product !== 'ding-pbx-console' || identity.candidateCommit !== manifest.sourceCommit || identity.logoDecoderManifestSha256 !== manifestSha256) throw new Error('The packaged decoder manifest is not bound to the packaged product identity.');
