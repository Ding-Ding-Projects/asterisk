...
export interface AttentionWiringRow { readonly id:string; readonly control:string; readonly mode:string|null; readonly controlDeclaration:AttentionMarker; readonly controlConstruction:AttentionMarker; readonly durableKey:AttentionMarker; readonly writerMarkers:readonly AttentionMarker[]; readonly setterMarkers:readonly AttentionMarker[]; readonly consumerMarkers:readonly AttentionMarker[]; }
