...
export const ATTENTION_MUTATION_INVENTORY: readonly AttentionMutationInventoryRow[] = [
  { file: 'App.tsx', line: 370, argument: "'attention-history-clear'", occurrence: 1, state: 'noticeHistory', clockEffect: 'recorded' },
  { file: 'App.tsx', line: 894, argument: "'vocabulary-load'", occurrence: 1, state: 'vocabularyCache', clockEffect: 'recorded' },
  { file: 'App.tsx', line: 907, argument: "'vocabulary-clear'", occurrence: 1, state: 'vocabularyCache', clockEffect: 'recorded' },
  { file: 'App.tsx', line: 970, argument: "'support-ticket'", occurrence: 1, state: 'supportTickets', clockEffect: 'recorded' },
  { file: 'App.tsx', line: 1100, argument: "'server-add'", occurrence: 1, state: 'servers', clockEffect: 'recorded' },
  { file: 'App.tsx', line: 1113, argument: "'server-remove'", occurrence: 1, state: 'servers', clockEffect: 'recorded' },
  { file: 'App.tsx', line: 1174, argument: "'onboarding-connect'", occurrence: 1, state: 'servers', clockEffect: 'recorded' },
...
const APP_SEVERITY_PRODUCER_SITES = [
  ...
  [858, 9, 'notifyMessage', 'info', false],
  [861, 11, 'notifyEvent', 'error', false],
  [895, 13, 'notifyMessage', 'info', false],
  [897, 16, 'notifyEvent', 'error', false],
  [899, 32, 'notifyEvent', 'error', false],
  [908, 9, 'notifyMessage', 'info', false],
  [915, 11, 'notifyEvent', 'warning', false],
  [918, 9, 'notifyMessage', 'info', false],
  [921, 11, 'notifyEvent', 'error', false],
  [929, 9, 'notifyEvent', 'info', false],
  [966, 11, 'notifyEvent', 'error', false],
  [971, 9, 'notifyEvent', 'info', false],
  [1016, 13, 'notifyEvent', 'error', false],
  [1022, 11, 'notifyMessage', 'info', false],
  [1032, 11, 'notifyMessage', 'info', false],
  [1101, 11, 'notifyEvent', 'info', false],
  [1103, 14, 'notifyEvent', 'error', false],
  [1109, 24, 'notifyEvent', 'error', false],
  [1114, 11, 'notifyEvent', 'info', false],
  [1116, 14, 'notifyEvent', 'error', false],
  [1175, 11, 'notifyEvent', 'info', false],
  [1181, 11, 'notifyEvent', 'error', false],
  [1193, 13, 'notifyEvent', 'warning', false],
  [1196, 11, 'notifyMessage', 'info', false],
  [1199, 13, 'notifyEvent', 'error', false],
  [1204, 13, 'notifyEvent', 'warning', false],
  [1223, 11, 'notifyEvent', 'warning', false],
  [1238, 17, 'notifyEvent', 'error', false],
  [1242, 15, 'notifyEvent', 'info', false],
...
export interface AttentionStructuredNoticeProducer { readonly id:string; readonly file:'App.tsx'|'generated/console.tsx'; readonly line:number; readonly marker:string; readonly kind:'path'|'url'|'credential'; }
export const ATTENTION_STRUCTURED_NOTICE_PRODUCERS: readonly AttentionStructuredNoticeProducer[] = [
  { id:'export-filename', file:'App.tsx', line:1343, marker:"sensitiveSpanForValue(noticeBody, filename, 'path')", kind:'path' },
  { id:'endpoint-secret', file:'App.tsx', line:1589, marker:"sensitiveSpanForValue(noticeBody, draft.secret, 'credential')", kind:'credential' },
];
