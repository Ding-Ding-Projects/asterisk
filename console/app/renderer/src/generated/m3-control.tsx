...
function Template(v: any) {
  return F(
    h("div", { role: `group`, "aria-labelledby": v.labelId, "aria-describedby": v.describedBy, "aria-disabled": v.isDisabled, "data-control-kind": v.ctl.kind, "data-palette-control": v.ctl.presentationId ? true : false, "data-appearance-id": v.ctl.presentationId || ('control-' + v.ctl.id), style: sty(`display:flex; flex-direction:column; gap:10px; min-width:0; max-width:100%;`) },
      h("div", { style: sty(`display:flex; align-items:center; gap:8px; min-width:0; flex-wrap:wrap;`) },
        ...
        (v.showInfoAction ? h("button", { "data-appearance-id": "direct-m3control-0_0_1_7_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_1_7_1", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.ctl.onInfo), "aria-label": `Explain ${S(v.ctl.label)}`, title: `Explain this setting`, style: sty(`min-width:48px; min-height:48px; border-radius:24px; background:#262B26; border:1px solid #414942; color:#82D9A5; cursor:pointer; display:flex; align-items:center; justify-content:center; flex:0 0 auto; outline-offset:3px;`), className: "c-h0" },
            h("span", { "aria-hidden": `true`, style: sty(`font-size:19px;`), className: "msym" },
              "info"
            )
          ) : null),
        (v.showWizardAction ? h("button", { "data-appearance-id": "direct-m3control-0_0_1_9_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_1_9_1", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.ctl.onWizard), "aria-label": `Open guided setup for ${S(v.ctl.label)}`, title: `Walk me through this setting`, style: sty(`min-width:48px; min-height:48px; border-radius:24px; background:#262B26; border:1px solid #414942; color:#82D9A5; cursor:pointer; display:flex; align-items:center; justify-content:center; flex:0 0 auto; outline-offset:3px;`), className: "c-h0" },
            h("span", { "aria-hidden": `true`, style: sty(`font-size:19px;`), className: "msym" },
              "auto_fix_high"
            )
          ) : null),
      ...
      (v.isAction ? h("button", { "data-appearance-id": "direct-m3control-0_0_9_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_9_1", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.actionHandler), disabled: v.actionDisabled, "aria-disabled": v.actionDisabled, "aria-describedby": v.describedBy, style: sty(`min-height:48px; align-self:flex-start; max-width:100%; background:#82D9A5; color:#00391F; border:0; border-radius:999px; padding:10px 18px; font-family:Roboto,sans-serif; font-size:12.5px; font-weight:600; cursor:pointer; overflow-wrap:anywhere; outline-offset:3px;`), className: "c-h2" },
          S(v.actionLabel)
        ) : null),
      ...
      (v.isSelect ? h("div", { style: sty(`display:flex; flex-direction:column; gap:8px; min-width:0; max-width:100%;`) },
          ...
          (v.regexOpen ? h("div", { id: v.regexPanelId, role: `region`, "aria-label": `Regex builder for ${S(v.ctl.label)} choices`, style: sty(`align-self:flex-start; width:min(100%,520px); max-height:70vh; overflow:auto; background:#20271F; border:1px solid #414942; border-radius:14px; padding:12px; box-shadow:0 8px 24px rgba(0,0,0,.45); display:flex; flex-direction:column; gap:10px;`) },
              h("div", { style: sty(`display:flex; align-items:center; gap:8px; flex-wrap:wrap;`) },
                h("button", { "data-appearance-id": "direct-m3control-0_0_15_1_5_1_1_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_15_1_5_1_1_1", 'ctl'), "data-direct-interactive": true, type: `button`, role: `switch`, "aria-checked": v.regexEnabled, onClick: fn(v.toggleRegexMode), style: sty(`min-height:48px; background:#262B26; border:1px solid #414942; border-radius:999px; color:#C4CBC2; padding:9px 14px; cursor:pointer; outline-offset:3px;`), className: "c-h0" },
              ...
              h("input", { "data-appearance-id": "direct-m3control-0_0_15_1_5_1_5" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_15_1_5_1_5", 'ctl'), "data-direct-interactive": true, id: v.regexInputId, type: `text`, value: v.filterQuery, onChange: fn(v.onFilterInput), onInput: fn(v.onFilterInput), "aria-invalid": v.regexInvalid, "aria-describedby": v.filterStatusId, placeholder: `Type a pattern`, autoComplete: `off`, spellCheck: `false`, style: sty(`width:100%; min-height:48px; background:#141A15; border:1px solid #414942; border-radius:10px; padding:10px 12px; color:#9FF7C4; font-family:'Roboto Mono',monospace; font-size:13px; outline-offset:3px;`) }),
              h("div", { role: `group`, "aria-label": `Regex flags`, style: sty(`display:flex; flex-wrap:wrap; gap:6px;`) },
                I(v.regexFlags, "{{ regexFlags }}", "f").map(($f, $f$i) => R($f$i, h("button", { "data-appearance-id": "direct-m3control-0_0_15_1_5_1_7_1_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_15_1_5_1_7_1_1", 'ctl') + '-' + stableDynamicIdentity($f, "m3control-0_0_15_1_5_1_7_1_1", "f"), "data-direct-interactive": true, type: `button`, "aria-pressed": $f.on, onClick: fn($f.toggle), style: sty(`min-width:48px; min-height:48px; background:${S($f.bg)}; border:1px solid #414942; border-radius:10px; color:${S($f.fg)}; padding:8px 12px; font-family:'Roboto Mono',monospace; cursor:pointer; outline-offset:3px;`), className: "c-h5" },
                    S($f.label)
                  )))
              ),
      ...
      (v.isStepper ? h("div", { style: sty(`display:flex; align-items:center; gap:8px; flex-wrap:wrap; max-width:100%;`) },
          h("button", { "data-appearance-id": "direct-m3control-0_0_19_1_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_19_1_1", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.decreaseAction), disabled: v.decreaseDisabled, "aria-label": `Decrease ${S(v.ctl.label)}`, style: sty(`min-width:48px; min-height:48px; border-radius:24px; background:#262B26; border:1px solid #414942; color:#C4CBC2; cursor:pointer; display:flex; align-items:center; justify-content:center; flex:0 0 auto; outline-offset:3px;`), className: "c-h6" },
            h("span", { "aria-hidden": `true`, style: sty(`font-size:20px;`), className: "msym" },
              "remove"
            )
          ),
          h("input", { "data-appearance-id": "direct-m3control-0_0_19_1_3" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_19_1_3", 'ctl'), "data-direct-interactive": true, id: v.primaryId, type: `number`, inputMode: `decimal`, min: v.ctl.min, max: v.ctl.max, step: v.stepVal, value: v.numText, onChange: fn(v.onNumInput), onInput: fn(v.onNumInput), "aria-valuemin": v.ctl.min, "aria-valuemax": v.ctl.max, "aria-valuenow": v.ctl.value, "aria-describedby": v.describedBy, disabled: v.numberDisabled, style: sty(`width:96px; max-width:100%; min-height:48px; background:#141A15; border:1px solid #414942; border-radius:10px; padding:8px 10px; color:#DFE4DC; font-family:'Roboto Mono',monospace; font-size:17px; text-align:center; outline-offset:3px;`) }),
          h("button", { "data-appearance-id": "direct-m3control-0_0_19_1_5" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_19_1_5", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.increaseAction), disabled: v.increaseDisabled, "aria-label": `Increase ${S(v.ctl.label)}`, style: sty(`min-width:48px; min-height:48px; border-radius:24px; background:#262B26; border:1px solid #414942; color:#C4CBC2; cursor:pointer; display:flex; align-items:center; justify-content:center; flex:0 0 auto; outline-offset:3px;`), className: "c-h6" },
            h("span", { "aria-hidden": `true`, style: sty(`font-size:20px;`), className: "msym" },
              "add"
            )
          ),
          h("button", { "data-appearance-id": "direct-m3control-0_0_19_1_7" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_19_1_7", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.togglePad), disabled: v.numberDisabled, "aria-expanded": v.padOpen, "aria-controls": v.padId, "aria-label": `Open number pad for ${S(v.ctl.label)}`, title: `Number pad`, style: sty(`min-width:48px; min-height:48px; border-radius:10px; background:#262B26; border:1px solid #414942; color:#82D9A5; cursor:pointer; display:flex; align-items:center; justify-content:center; flex:0 0 auto; outline-offset:3px;`), className: "c-h0" },
            h("span", { "aria-hidden": `true`, style: sty(`font-size:19px;`), className: "msym" },
              "dialpad"
            )
          ),
      ...
      (v.isSlider ? h("div", { style: sty(`display:grid; grid-template-columns:minmax(120px,1fr) minmax(84px,110px) 48px; align-items:center; gap:8px; max-width:100%;`) },
          h("input", { "data-appearance-id": "direct-m3control-0_0_21_1_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_21_1_1", 'ctl'), "data-direct-interactive": true, id: v.primaryId, type: `range`, min: v.ctl.min, max: v.ctl.max, step: v.stepVal, value: v.ctl.value, onInput: fn(v.sliderAction), onChange: fn(v.sliderAction), "aria-valuemin": v.ctl.min, "aria-valuemax": v.ctl.max, "aria-valuenow": v.ctl.value, "aria-valuetext": v.sliderDisplay, "aria-describedby": v.describedBy, disabled: v.sliderDisabled, style: sty(`width:100%; min-width:0; min-height:48px; outline-offset:3px;`) }),
          h("input", { "data-appearance-id": "direct-m3control-0_0_21_1_3" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_21_1_3", 'ctl'), "data-direct-interactive": true, id: v.numberId, type: `number`, inputMode: `decimal`, min: v.ctl.min, max: v.ctl.max, step: v.stepVal, value: v.numText, onChange: fn(v.onNumInput), onInput: fn(v.onNumInput), "aria-label": `Exact value for ${S(v.ctl.label)}`, "aria-describedby": v.describedBy, disabled: v.numberDisabled, style: sty(`width:100%; min-width:0; min-height:48px; background:#141A15; border:1px solid #414942; border-radius:10px; padding:8px 9px; color:#DFE4DC; font-family:'Roboto Mono',monospace; font-size:13px; text-align:center; outline-offset:3px;`) }),
          h("button", { "data-appearance-id": "direct-m3control-0_0_21_1_5" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_21_1_5", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.togglePad), disabled: v.numberDisabled, "aria-expanded": v.padOpen, "aria-controls": v.padId, "aria-label": `Open number pad for ${S(v.ctl.label)}`, title: `Number pad`, style: sty(`width:48px; height:48px; border-radius:10px; background:#262B26; border:1px solid #414942; color:#82D9A5; cursor:pointer; display:flex; align-items:center; justify-content:center; outline-offset:3px;`), className: "c-h0" },
      ...
      (v.padOpen ? h("div", { id: v.padId, role: `dialog`, "aria-modal": `false`, "aria-label": `Number pad for ${S(v.ctl.label)}`, style: sty(`width:min(100%,360px); background:#0C110D; border:1px solid #414942; border-radius:14px; padding:12px;`) },
          ...
          h("div", { style: sty(`display:grid; grid-template-columns:repeat(3,minmax(48px,1fr)); gap:6px;`) },
            I(v.padKeys, "{{ padKeys }}", "k").map(($k, $k$i) => R($k$i, h("button", { "data-appearance-id": "direct-m3control-0_0_23_1_3_1_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_23_1_3_1_1", 'ctl') + '-' + stableDynamicIdentity($k, "m3control-0_0_23_1_3_1_1", "k"), "data-direct-interactive": true, type: `button`, onClick: fn($k.press), "aria-label": $k.accessibleLabel, style: sty(`min-width:48px; min-height:48px; border-radius:10px; background:linear-gradient(#20281F,#171D18); border:1px solid #414942; color:#DFE4DC; font-family:'Roboto Mono',monospace; font-size:17px; cursor:pointer; box-shadow:0 2px 0 #0C110D; outline-offset:3px;`), className: "c-h7" },
                S($k.label)
              )))
          ),
          h("div", { style: sty(`display:flex; gap:6px; margin-top:8px; flex-wrap:wrap;`) },
            h("button", { "data-appearance-id": "direct-m3control-0_0_23_1_5_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_23_1_5_1", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.padClear), style: sty(`flex:1 1 100px; min-height:48px; border-radius:10px; background:#262B26; border:1px solid #414942; color:#C4CBC2; font:inherit; font-size:12.5px; cursor:pointer; outline-offset:3px;`) },
              "Clear"
            ),
            h("button", { "data-appearance-id": "direct-m3control-0_0_23_1_5_3" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_23_1_5_3", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.padApply), disabled: v.padApplyDisabled, style: sty(`flex:2 1 160px; min-height:48px; border-radius:10px; background:#82D9A5; border:0; color:#00391F; font:inherit; font-size:12.5px; font-weight:600; cursor:pointer; outline-offset:3px;`) },
              `Set ${S(v.padValue)}`
            )
          )
        ) : null),
      (v.isOrder ? h("div", { style: sty(`display:flex; flex-direction:column; gap:8px; min-width:0; max-width:100%;`) },
          h("ol", { "aria-labelledby": v.labelId, "aria-describedby": v.describedBy, style: sty(`list-style:none; margin:0; padding:0; display:flex; flex-direction:column; gap:6px; min-width:0;`) },
            I(v.dragItems, "{{ dragItems }}", "i").map(($i, $i$i) => R($i$i, h("li", { "data-appearance-id": "direct-m3control-0_0_25_1_1_1_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_25_1_1_1_1", 'ctl') + '-' + stableDynamicIdentity($i, "m3control-0_0_25_1_1_1_1", "i"), "data-direct-interactive": true, draggable: $i.draggable, "aria-current": $i.current, "aria-posinset": $i.position, "aria-setsize": v.orderSize, onDragStart: fn($i.onDragStart), onDragOver: fn($i.onDragOver), onDrop: fn($i.onDrop), onDragEnd: fn($i.onDragEnd), style: sty(`display:flex; align-items:center; gap:8px; min-height:48px; min-width:0; background:${S($i.bg)}; border:1px solid #333B34; border-radius:10px; padding:5px 6px 5px 12px; cursor:${S($i.cursor)};`) },
                ...
                h("button", { "data-appearance-id": "direct-m3control-0_0_25_1_1_1_1_5" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_25_1_1_1_1_5", 'ctl') + '-' + stableDynamicIdentity($i, "m3control-0_0_25_1_1_1_1_5", "i"), "data-direct-interactive": true, type: `button`, onClick: fn($i.upSafe), disabled: $i.upDisabled, "aria-label": `Move ${S($i.label)} up`, style: sty(`min-width:48px; min-height:48px; border-radius:24px; background:transparent; border:1px solid transparent; color:#9AA39B; cursor:pointer; outline-offset:3px;`), className: "c-h8" },
                  h("span", { "aria-hidden": `true`, style: sty(`font-size:17px;`), className: "msym" },
                    "arrow_upward"
                  )
                ),
                h("button", { "data-appearance-id": "direct-m3control-0_0_25_1_1_1_1_7" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_25_1_1_1_1_7", 'ctl') + '-' + stableDynamicIdentity($i, "m3control-0_0_25_1_1_1_1_7", "i"), "data-direct-interactive": true, type: `button`, onClick: fn($i.downSafe), disabled: $i.downDisabled, "aria-label": `Move ${S($i.label)} down`, style: sty(`min-width:48px; min-height:48px; border-radius:24px; background:transparent; border:1px solid transparent; color:#9AA39B; cursor:pointer; outline-offset:3px;`), className: "c-h8" },
                  h("span", { "aria-hidden": `true`, style: sty(`font-size:17px;`), className: "msym" },
                    "arrow_downward"
                  )
                ),
                h("button", { "data-appearance-id": "direct-m3control-0_0_25_1_1_1_1_9" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_25_1_1_1_1_9", 'ctl') + '-' + stableDynamicIdentity($i, "m3control-0_0_25_1_1_1_1_9", "i"), "data-direct-interactive": true, type: `button`, onClick: fn($i.dropSafe), disabled: $i.dropDisabled, "aria-label": `Remove ${S($i.label)}`, style: sty(`min-width:48px; min-height:48px; border-radius:24px; background:transparent; border:1px solid transparent; color:#9AA39B; cursor:pointer; outline-offset:3px;`), className: "c-h9" },
                  h("span", { "aria-hidden": `true`, style: sty(`font-size:17px;`), className: "msym" },
                    "close"
                  )
                )
      ...
      (v.isFile ? h("div", { style: sty(`display:flex; flex-direction:column; gap:8px; min-width:0; max-width:100%;`) },
          h("input", { "data-appearance-id": "direct-m3control-0_0_29_1_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_29_1_1", 'ctl'), "data-direct-interactive": true, id: v.primaryId, type: `file`, accept: v.ctl.accept, "aria-describedby": v.describedBy, onChange: fn(v.filePickAction), disabled: v.fileDisabled, style: sty(`width:100%; min-height:48px; background:#141A15; border:1px dashed #414942; border-radius:10px; padding:9px 12px; color:#DFE4DC; font-family:'Roboto Mono',monospace; font-size:12.5px; outline-offset:3px;`) }),
          h("div", { role: `status`, "aria-live": `polite`, style: sty(`font-size:11.5px; color:#C4CBC2; overflow-wrap:anywhere;`) },
            S(v.fileStatus)
          ),
          (v.showFileClear ? h("button", { "data-appearance-id": "direct-m3control-0_0_29_1_5_1" + '-' + stableDynamicIdentity(v.ctl, "m3control-0_0_29_1_5_1", 'ctl'), "data-direct-interactive": true, type: `button`, onClick: fn(v.fileClearAction), disabled: v.fileClearDisabled, style: sty(`align-self:flex-start; min-height:48px; max-width:100%; display:flex; align-items:center; justify-content:center; gap:7px; background:transparent; border:1px solid #414942; border-radius:10px; padding:9px 14px; color:#C4CBC2; font:inherit; font-size:12px; cursor:pointer; overflow-wrap:anywhere; outline-offset:3px;`), className: "c-h11" },
...
class M3Control extends DCLogic {
  ...
  renderVals() {
    ...
    const textEditable = c.editable === true || String(c.id || '').startsWith('pbxadm:');
    ...
    const choices = (c.options || []).map((rawOption, index) => {
      const option = typeof rawOption === 'string' ? { id:rawOption, key:rawOption, value:rawOption, label:rawOption } : rawOption;
      const stableId = option && (option.id ?? option.key);
      if (typeof stableId !== 'string' || stableId.trim() === '') throw new Error('M3 Control choice item is missing stable id/key.');
      ...
      return Object.assign({}, option, { id:stableId, key:stableId,
    ...
    const orderItems = (c.items || []).map(item => {
      const stableId = item && (item.id ?? item.key);
      if (typeof stableId !== 'string' || stableId.trim() === '') throw new Error('M3 Control order item is missing stable id/key.');
      return Object.assign({}, item, { id:stableId, key:stableId });
    });
    ...
    const poolItems = (c.pool || []).map(item => {
      const stableId = item && (item.id ?? item.key);
      if (typeof stableId !== 'string' || stableId.trim() === '') throw new Error('M3 Control pool item is missing stable id/key.');
      const addFn = typeof item.add === 'function' ? item.add : null;
      return Object.assign({}, item, { id:stableId, key:stableId, disabled:baseDisabled || !addFn, addSafe:safe(addFn) });
    });
    ...
    return {
      ...
      regexFlags:['i','m','s','u'].map(flag => {
        ...
        return { id:flag, key:flag, label:flag, on, bg:on ? '#005230' : '#262B26', fg:on ? '#9FF7C4' : '#C4CBC2',
      ...
      padKeys:['1','2','3','4','5','6','7','8','9','.','0','⌫'].map(character => ({
        id:character, key:character, label:character, accessibleLabel:character === '⌫' ? 'Backspace' : (character === '.' ? 'Decimal point' : character),
