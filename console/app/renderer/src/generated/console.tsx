...
const SCREENS = {
  ...
  customise:{ rail:'app', icon:'auto_awesome', label:'Customise everything', badge:'∞', title:'Customise everything', file:'console profile', kind:'generic',
    ...
    { title:'Language', desc:'Which language the console speaks. Bilingual keeps English primary and adds the Cantonese beside it. Technical identifiers -- codecs, config keys, section names, SIP URIs -- stay literal in every mode, because they have to survive being read back and typed.', ctls:[
      ...
      ctl('school_set_credential','Set unlock credential','switch',false,{ info:'Opens an app-owned credential dialog. The credential is kept by the operating-system credential vault for this installed desktop console, never in settings, exports or history.' }),
      ...
      ctl('fun_english_reset','Reset English funny level','switch',false,{ info:'Switch on to return only the English level to 5. The Cantonese level is left untouched.' }),
      ctl('fun_cantonese_reset','Reset Cantonese funny level','switch',false,{ info:'Switch on to return only the Cantonese level to 5. The English level is left untouched.' }),
