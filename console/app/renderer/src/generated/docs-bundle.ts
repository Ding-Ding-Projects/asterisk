...
export const DOCS_BUNDLE: DocsBundle = {
  ...
  "articles": [
    ...
    {
      "id": "platform/migration-backups-git",
      "category": "platform",
      "title": "Migration, verified backups, and local Git management",
      "headings": [
        {
        ...
        {
          "title": "Backups and partial outcomes",
          "id": "backups-and-partial-outcomes"
        },
        {
          "title": "Local Git management",
          "id": "local-git-management"
        },
        {
          "title": "Verification boundary",
          "id": "verification-boundary"
