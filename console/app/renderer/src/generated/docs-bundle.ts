...
export const DOCS_BUNDLE: DocsBundle = {
  ...
  "articles": [
    ...
    {
      "id": "changelog-fragments/browser-extension-transfer",
      "category": "changelog-fragments",
    ...
    {
      "id": "changelog-fragments/dim-sum-runtime",
      "category": "changelog-fragments",
    ...
    {
      "id": "changelog-fragments/logo-conversion",
      "category": "changelog-fragments",
    ...
    {
      "id": "changelog-fragments/status-hub-client",
      "category": "changelog-fragments",
    ...
    },
    {
      ...
      "headings": [
        ...
        {
          "title": "Failure modes and privacy",
          "id": "failure-modes-and-privacy"
        },
        {
          "title": "Verification boundary",
          "id": "verification-boundary"
    ...
    },
    {
      ...
      "headings": [
        ...
        {
          "title": "Failure modes and queue states",
          "id": "failure-modes-and-queue-states"
        },
        {
          "title": "PDF commands",
          "id": "pdf-commands"
