...
export const DOCS_BUNDLE: DocsBundle = {
  ...
  "articles": [
    ...
    },
    {
      ...
      "headings": [
        {
          "title": "Immutable materialized handoffs",
          "id": "immutable-materialized-handoffs"
        },
        {
          "title": "Renderer mutation notices stay truthful",
          "id": "renderer-mutation-notices-stay-truthful"
        },
        {
          "title": "Suggested articles",
          "id": "suggested-articles"
    ...
    },
    {
      ...
      "headings": [
        ...
        {
          "title": "Export producer inventory",
          "id": "export-producer-inventory"
        },
        {
          "title": "Accessibility and localization",
          "id": "accessibility-and-localization"
