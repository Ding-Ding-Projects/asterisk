...
export const DOCS_BUNDLE: DocsBundle = {
  ...
  "articles": [
    ...
    },
    {
      ...
      "headings": [
        {
          "title": "Current delivery note",
          "id": "current-delivery-note"
        }
      ],
      "links": [
        "servers.md",
      ...
      "body": "# App\n\n## Current delivery note\n\nThe current documentation source is carried by `main` at\n`7c6e0c6c9520c6fd421cabf73bcbb6af15a18c60`. The published console and installer ISO releases\ntarget that SHA. Their delivery workflows completed successfully, while local tests and current\nbuilt-application interaction remain separate evidence requirements and are not inferred here.\n\nDeploy & application: stand up a new server, then appearance, updates and the console itself.\n\n- [Deploy & servers](servers.md)\n- [Arcade](arcade.md)\n- [Notifications](notifications.md)\n- [History & git](history.md)\n- [Customise everything](customise.md)\n- [Appearance](appearance.md)\n- [About & policy](about.md)\n"
    },
    {
      "id": "app/servers",
      "category": "app",
    ...
    {
      "id": "evidence/design-parity-v2-capture-plan",
      "category": "evidence",
      "title": "Design parity schema-v2 capture plan",
      "headings": [
        {
        ...
        {
          "title": "Final candidate sequence",
          "id": "final-candidate-sequence"
        },
        {
    ...
    {
      "id": "evidence/surface-evidence-integrity",
      "category": "evidence",
      "title": "What a `verified` surface row now has to survive",
      "headings": [
        {
          "title": "What presence alone let through",
          "id": "what-presence-alone-let-through"
        },
        {
          "title": "The bar a row now has to clear",
          "id": "the-bar-a-row-now-has-to-clear"
        },
        {
          "title": "The contradiction this uncovered, and why it is not resolved here",
          "id": "the-contradiction-this-uncovered-and-why-it-is-not-resolved-here"
        },
        {
          "title": "What moved",
          "id": "what-moved"
        ...
        {
          "title": "How the guards were proved",
          "id": "how-the-guards-were-proved"
        },
        {
          "title": "Suggested articles",
          "id": "suggested-articles"
    ...
    },
    {
      ...
      "headings": [
        ...
        {
          "title": "Local conversion and cache",
          "id": "local-conversion-and-cache"
        },
        {
          "title": "Configuration",
          "id": "configuration"
    ...
    {
      "id": "platform/privileged-service-boundaries",
      "category": "platform",
      "title": "Privileged service boundaries",
      "headings": [
        {
          "title": "Personal vocabulary",
          "id": "personal-vocabulary"
        ...
        {
          "title": "File conversion and PDF",
          "id": "file-conversion-and-pdf"
        },
        {
          "title": "Local Ollama",
          "id": "local-ollama"
    ...
    },
    {
      ...
      "links": [
        ...
        "privileged-service-boundaries.md"
      ],
    ...
    },
    {
      ...
      "headings": [
        {
          "title": "Current delivery record",
          "id": "current-delivery-record"
        },
        {
          "title": "Rails",
          "id": "rails"
    ...
    {
      "id": "release-drafts/2026-08-31-release-records",
      "category": "release-drafts",
      "title": "Public record drafts for the 2026-08-31 release closeout",
      "headings": [
        {
          "title": "Issue #1, start comment draft",
          "id": "issue-1-start-comment-draft"
        },
        {
          "title": "Issue #1, milestone comment draft",
          "id": "issue-1-milestone-comment-draft"
        },
        {
          "title": "Issue #1, finished comment draft",
          "id": "issue-1-finished-comment-draft"
        },
        {
          "title": "Issue #6 disposition draft",
          "id": "issue-6-disposition-draft"
        },
        {
          "title": "Rolling Discussion #2 draft",
          "id": "rolling-discussion-2-draft"
        },
        {
          "title": "Per-release Announcement draft",
          "id": "per-release-announcement-draft"
        },
        {
          "title": "Project #24 draft",
          "id": "project-24-draft"
        },
        {
          "title": "Wiki draft",
