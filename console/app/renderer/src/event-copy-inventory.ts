...
export const DYNAMIC_EVENT_COPY_INVENTORY: readonly DynamicEventCopyRecord[] = [
  ...
  { key: '<dynamic-title>', kind: 'dialog-title', status: 'english-fallback', reason: 'Template titles use the plain-English fallback policy.' },
  { key: '<dynamic-body>', kind: 'dialog-body', status: 'english-fallback', reason: 'Template bodies use the plain-English fallback policy.' },
