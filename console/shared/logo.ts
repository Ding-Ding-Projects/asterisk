...
export interface LogoHandlerDescriptor {
  readonly action: 'logo.decoder.status' | 'logo.inspect' | 'logo.convert' | 'logo.cache.peek-stored' | 'logo.cache.read' | 'logo.cache.asset.read' | 'logo.cache.write' | 'logo.cache.clear';
  readonly localOnly: true;
...
export const LOGO_HANDLER_DESCRIPTORS: readonly LogoHandlerDescriptor[] = Object.freeze([
  ...
  { action: 'logo.cache.peek-stored', localOnly: true, input: 'LogoCacheReadRequest', output: 'LogoCacheRecord | undefined' },
