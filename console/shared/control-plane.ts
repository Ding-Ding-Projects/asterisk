...
export type ControlPlaneAction =
  ...
  | 'local-history.status' | 'local-history.authorize' | 'local-history.list' | 'local-history.record' | 'local-history.retry' | 'local-history.restore-plan' | 'local-history.restore'
