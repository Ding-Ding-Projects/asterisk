...
const assets = ['index.html', 'product.html', 'documentation.html', 'downloads.html', 'status.html', 'settings.html', 'styles.css', 'app.js', 'global-settings.js', 'dim-sum-cache.json'];
