...
for (const asset of assets) {
  ...
  if (asset.endsWith('.html')) {
    // Source pages sit in console/site/, so they reach the vendored fonts through
    // ../assets/fonts/. Built pages sit one level deeper at console/site/dist/ and
    // carry their own copy at dist/assets/fonts/, so the href loses the ../ here.
...
await cp(fonts, join(output, 'assets', 'fonts'), { recursive: true });
