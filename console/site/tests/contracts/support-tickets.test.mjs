...
test('the site feature registry carries an implemented-unverified row for support-tickets', () => {
  ...
  for (const file of ['site/app.js', 'site/settings.html', 'site/documentation.html', 'site/styles.css']) {
    assert.ok(row.implementation.paths.includes(file), `the row does not name ${file}, which the feature is partly built in`);
  }
});
