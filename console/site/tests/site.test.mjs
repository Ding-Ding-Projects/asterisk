...
test('provides 77 complete feature articles plus checked evidence records', async () => {
  ...
  // 76 (32 destination articles across pbx/media/data/system/agent/app plus 44 platform
  // articles), plus one more: docs/pbx/iaxpeers.md, the IAX peers screen's own previously
  // missing documentation article, added alongside the Trunks/IVR deepening pass.
...
test('build composes deterministic local output without fetches', async () => {
  ...
  // One article in, one HTML page out.
  // 192 from the w2-deepen stacking lane, for docs/pbx/iaxpeers.md, the IAX peers screen's own
