...
- [x] Add a partial browser-local authenticator equivalent with manual Base32 registration, an `otpauth://` pairing URI, live current and next TOTP codes, and ordinary-export secret omission. QR rendering, platform vault storage, and runtime proof remain unavailable.
