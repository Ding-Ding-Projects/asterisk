...
- [x] **Migration, verified backups, and local Git management** — versioned non-secret manifest, machine-readable omissions, verified `git bundle` history, staged import with backup and rollback, bounded backup records, and normal non-force remote receipts. Runtime import and remote mutation evidence remains open.
