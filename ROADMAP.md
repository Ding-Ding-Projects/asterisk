...
- [x] Repair startup eligibility, durable onboarding completion, hosted browser-local cache behavior, bounded privileged reads, independent image inspection, canonical navigation identities, and truthful partial registry claims. Built-artifact proof remains unrun.
