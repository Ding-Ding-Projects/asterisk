...
- The Status Hub projection now requires a separately schema-validated receipt containing matching commit, tag, evidence URL, and evidence hash before it can display Verified. A user-entered Setup URL alone is never sufficient.
